    ...
    return (
        <section>
            ...
            {props.ingredients.length > 3 && <div className="bg-[#f0efeb] rounded-lg flex p-[20px] justify-between items-center">
                ...
                <button className="bg-[#d17557] text-[#fafaf8] text-[0.7rem] px-[17px] py-[7px] rounded-md shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] cursor-pointer" onClick={props.handleToggleRecipe}>Get a recipe</button>
            </div>}
